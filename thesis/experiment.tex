...
Figure \ref{network-diagram-with-tor-encrypted} shows the network configuration when
...
describe "site1.static.torsim.1" do
  ...
  it "test_site1.static.torsim.1" do
    page.open "/"
  end
end
\end{lstlisting}
...
removing execute permissions from the file \verb+/etc/init.d/tor+.
